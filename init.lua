...
-- Set shift space to space for lazy git commit issues
...
-- Move and center up and down
vim.keymap.set('n', '<C-u>', '<C-u>zz', { desc = 'Move up and then recenter' })
vim.keymap.set('n', '<C-d>', '<C-d>zz', { desc = 'Move down and then recenter' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Function to allow opening a single file or multiple in tabs if any are selected
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function(_, opts)
      ...
      -- The main branch uses Neovim's built-in highlighting API and no longer
